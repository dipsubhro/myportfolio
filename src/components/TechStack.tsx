...
const devicon = (name: string, variant: string = "original") =>
    `${DEVICON_BASE}/${name}/${name}-${variant}.svg`;

const QdrantIcon = ({ className }: { className?: string }) => (
    <svg role="img" viewBox="0 0 24 24" fill="#D91656" className={className}>
        ...
        <text x="12" y="17" fontSize="16" fontWeight="bold" textAnchor="middle" fill="#D91656">Q</text>
    </svg>
);

const TanStackIcon = ({ className }: { className?: string }) => (
    <svg role="img" viewBox="0 0 24 24" fill="#FF4154" className={className}>
    ...
    const techCategories: { name: string; techs: (TechItem | { name: string; customIcon: string })[] }[] = [
        {
            ...
            techs: [
                ...
                { name: "HTML", icon: devicon("html5", "original") },
                { name: "CSS", icon: devicon("css3", "original") },
            ],
        },
        {
            name: "Frontend",
            techs: [
                ...
                { name: "TanStack Query", customIcon: "tanstack" },
        ...
        },
        {
            ...
            techs: [
                ...
                { name: "Express.js", icon: devicon("express", "original"), invert: true },
                { name: "Socket.IO", icon: devicon("socketio", "original"), invert: true },
        ...
        },
        {
            ...
            techs: [
                ...
                { name: "Kubernetes", icon: devicon("kubernetes", "original") },
                { name: "Terraform", icon: devicon("terraform", "original") },
                { name: "Nginx", icon: devicon("nginx", "original") },
                { name: "Linux", icon: devicon("linux", "original") },
                { name: "Git", icon: devicon("git", "original") },
                { name: "GitHub", icon: devicon("github", "original"), invert: true },
                { name: "GitHub Actions", icon: devicon("githubactions", "original") },
        ...
        },
        {
            ...
            techs: [
                ...
                { name: "Neovim", icon: devicon("neovim", "original") },
                { name: "Postman", icon: devicon("postman", "original") },
                { name: "Vercel", icon: devicon("vercel", "original"), invert: true },
