  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h1 className="text-4xl lg:text-6xl font-light text-gray-800 mb-6 tracking-tight">
        ...
        <div className="flex justify-center space-x-6 mb-12">
          <a
            ...
            className="p-3 rounded-full bg-white shadow-md hover:shadow-lg transition-all duration-300 hover:scale-110 group border border-blue-100"
          >
        ...
        <div className="flex justify-center">
          <a
            href="#projects"
            className="inline-block px-8 py-3 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
          >
            View My Work
          </a>
        </div>
